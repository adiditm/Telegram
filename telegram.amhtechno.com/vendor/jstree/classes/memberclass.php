...
/*			if ($vres == 1 || $vres == 2)
		...
		function getWilName($pNeg,$pProp,$pKota,$pKec,$pKel) {	
            global $oDB; 
...
//Serial id Used
	...
	//REGISTER Withdraw
	 function regWithdraw($fidwithdraw,$fidmember,$fnominal, $ftglupdate,$fket,$frekfrom,$frekto,$fsync=0,$fcurr) {
			 global $oDB, $oRules;
	 		 $vsql="INSERT INTO tb_withdraw (fidwithdraw,fidmember ,  fnominal ,  ftglupdate,fket,frekfrom,frekto,fsync,fcurr) " ;
			 $vsql.="VALUES ('$fidwithdraw','$fidmember',  $fnominal, '$ftglupdate','$fket','$frekfrom','$frekto','$fsync','$fcurr');";	
			 $oDB->query($vsql);
