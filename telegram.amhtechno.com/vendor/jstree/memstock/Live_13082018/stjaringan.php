...
<div id="content" class="content">
			<ol class="breadcrumb pull-right">
				<h4>
				  <li><a href="javascript:;">Sponsor Status</a></li></h4>
...
<button style="margin-left:2em" class="btn btn-info btn-sm" onClick="document.location.href='../manager/getexcel.php?arr=stjarmem&file=sponsorship_report'"><i class="fa fa-file-text-o"></i> Export Excel</button> 
