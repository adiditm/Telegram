<? 
 ...
 if ($vSearch!="")	{	
  ...
  $vSQL="select count(*) as fjumrec from tb_kom_stockist where fkind in('bnstock','bnstockspon')  and fidmember='$vUserChoosed' $vCrit";
  ...
  <link rel="stylesheet" type="text/css" href="../js/bootstrap-datetimepicker/css/datetimepicker-custom.css" />
	...
	<div id="content" class="content">
			<ol class="breadcrumb pull-right">
				<h4>
				  <li><a href="javascript:;">Bonus Poin sebagai Stockist dan Pensponsoran Stockist</a></li></h4>
...
<br>
        ...
        <?
			    ...
			    $vSQL="select * from tb_kom_stockist where  fkind in('bnstock','bnstockspon') and fidmember='$vUserChoosed' ";
...
<?=number_format($vBal,0,",",".");?>
  ...
  <button style="margin-left:2em" class="btn btn-info btn-sm" onClick="document.location.href='../manager/getexcel.php?arr=ewallet&file=bns_ro_sponsor_report_<?=$vUserChoosed?>'"><i class="fa fa-file-text-o"></i> Export Excel</button> 
  <br ><br>
