<? 
 ...
 if ($vSearch!="")	{	
  ...
  $vSQL="select count(*) as fjumrec from tb_kom_stockist where fkind in('bnstrxkitst','bnstrxst')  and fidmember='$vUserChoosed' $vCrit";
  ...
  <link rel="stylesheet" type="text/css" href="../js/bootstrap-datetimepicker/css/datetimepicker-custom.css" />
	...
	<div id="content" class="content">
			<ol class="breadcrumb pull-right">
				<h4>
				  <li><a href="javascript:;">Bonus RO dari Stockist yang disponsori</a></li></h4>
