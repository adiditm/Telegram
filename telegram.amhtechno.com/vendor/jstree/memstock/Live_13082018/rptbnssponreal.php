<? 
 ...
 if ($vSearch!="")	{	
  ...
  $vSQL="select count(*) as fjumrec from tb_mutasi where fkind='spon' and fidmember='$vUserChoosed' $vCrit";
  ...
  <link rel="stylesheet" type="text/css" href="../js/bootstrap-datetimepicker/css/datetimepicker-custom.css" />
	...
	<div id="content" class="content">
			<ol class="breadcrumb pull-right">
				<h4><li><a href="javascript:;">Report Bonus  Sponsor <? if ($vRefUser !='') echo " ($vRefUser)";?></a></li></h4>
...
<br>
        ...
        <?
			    ...
			    $vSQL="select * from tb_mutasi where  fkind='spon' and fidmember='$vUserChoosed' ";
