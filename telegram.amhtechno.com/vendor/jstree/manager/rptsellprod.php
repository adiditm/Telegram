...
$(document).ready(function(){
    $('#caption').html('Ranking Produk (Nominal)');
    ...
    <div class="table-responsive">
        ...
        <table width="75%" border="0" class="table table-striped">
          <tr >
            ...
            <td width="19%" align="center" style="height: 24px"><div align="right"><strong> Penjualan (Rp)</strong></div></td>
            </tr>
          <? 
             $vNo=0;

			 
			 $vsql="select a.fidproduk, sum(a.fsubtotal) as fsub from tb_trxstok_member a where date(a.ftanggal) between '$vAwal' and '$vAkhir' group by a.fidproduk order by sum(a.fsubtotal) desc  "; 
		     $db->query($vsql);
			 $vTotJual=0;
