...
$(document).ready(function(){
      ...
      $('#caption').html('Stock Balance Correction');
...
function checkStock() {
   ...
   var vURL ='../main/mpurpose_ajax.php?op=checkstock&mem='+vMember+'&prod='+vProd;
  ...
  <tr valign="top"> 
    ...
    <td align="center" valign="top">
      ...
      <h3>Stock Adjustment <?=$oMember->getMemberName($vUserChoosed)?> (<?=$vUserChoosed?>)</h3>      <h4 style="color:blue">Choose Product, Size, and Color, then Check Stock</h4>
...
<select name="lmColor" id="lmColor" class="form-control">
                ...
                <? 
                   ...
                   $vSQL="select distinct fcolor from tb_stok_position where fidmember='$vUserChoosed' order by fidproduk";
