...
$sheet = $_SESSION[$vIndex];
  ...
  if ($vIndex !='statedaybm' && $vIndex !='statemonthbm')
...
header('Content-Disposition: attachment;filename="'.$vFileName.'.csv"');
header('Cache-Control: max-age=0');

  // Do your stuff here
  $writer = PHPExcel_IOFactory::createWriter($doc, 'CSV')->setDelimiter(',')->setEnclosure('')->setLineEnding("\r\n");
