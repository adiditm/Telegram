...
$(document).ready(function(){
    ...
    $('#caption').html('PE-RD Rewards Report ');
...
</form><button class="btn btn-info btn-sm" onClick="document.location.href='../manager/getexcel.php?arr=rewardso&file=reward_p_executive_up_report'"><i class="fa fa-file-text-o"></i> Export Excel</button> 
