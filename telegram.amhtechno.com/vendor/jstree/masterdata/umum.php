<?
  ...
  define("MENU_ID", "royal_page_edit");   
   ...
   $vID=$_GET['uID'];
   $vSQL="select * from m_admin where fidmember='$vID'";
   $db->query($vSQL);
   ...
   if ($_POST['hPost']=="1") {
	  ...
	  $vPostPrice=preg_replace("/\'/","`",$vPostPrice);
       $vSQL="update m_admin set ftask='$vPostDesc' where fidmember='$vID'";
	  $db->query($vSQL);
	...
	<table width="90%"  border="0" align="center" cellpadding="1" cellspacing="1" style="font-family:Tahoma,Verdana">
      <tr>
        <td colspan="3" align="center">
          <p><strong>Pengumuman</strong></p>          </td>
      </tr>
      <tr>
        <td width="33%"><div align="left"><strong>Username</strong></div></td>
      ...
      <tr>
        <td height="729" colspan="3" valign="top"><p align="left"><br />
          ...
          <p align="left"><strong>Pengumuman / Tugas</strong>:<br />
            <br />
