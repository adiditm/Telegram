...
if ($vSort =='T')
   ...
   $vOrder.=" order by ftotbelanja desc ";
			 ...
			 $vsql="select  fidmember,ftgldaftar,fnama,falamat,fstockfrom from m_anggota where 1  "; 
...
$(document).ready(function(){
    $('#caption').html('Registration Report ');
    ...
    <div class="table-responsive">
        <table border="0" class="table table-striped" style="width:98%">
          <tr >
            ...
            <td align="center" style="height: 24px; "><strong>Status </strong></td>
          ...
          <tr>
            ...
            <td style="height: 24px; " align="left"><? if($db->f('faktif')=='1') echo 'Active'; else echo 'Pending';?></td>
