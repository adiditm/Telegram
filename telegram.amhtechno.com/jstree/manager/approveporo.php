...
$(document).ready(function(){
    $('#caption').html('PO Approval for RO Items');
...
function doApprove(pIdSys,pIdTrx) {
   var vURL='../manager/processing_ajax.php?op=approvero&idsys='+pIdSys+'&idtrx='+pIdTrx;
...
<br />
    ...
    <div class="table-responsive">
        <table width="90%" border="0" class="table table-striped">
          ...
          <? 
             $vNo=0;
			 $vsql="select distinct ftanggal, fidpenjualan,fidseller,fidmember, fketerangan, '1' as fstatus  from tb_trxstok where   fkindtrx='purc2'"; 
			 $vsql.=$vCrit;

			 
			 $vsql.=" union all select distinct ftanggal, fidpenjualan,fidseller,fidmember, fketerangan, '0' as fstatus  from tb_trxstok_temp where   fkindtrx='purc2'"; 
			 $vsql.=$vCrit;
