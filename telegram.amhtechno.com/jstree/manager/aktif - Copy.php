...
<div class="content-wrapper" style="width:100%;background-color:#0FF">
...
<div align="left" class="table-responsive col-lg-6" > 
    ...
    <div align="left" style="float:left;margin-top:2em">
         ...
         <!--  <? if ($oSystem->checkPriv($vUser,"mdm_listprof_repkit")) { ?><input name="btKit" type="button" class="btn btn-success btn-sm" id="bKit" onclick="MM_goToURL('parent','../memstock/rptkit.php?&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Agent KIT Report &raquo;" onMouseovers="showhint('KIT Agent '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?> -->
          ...
          <? if ($oSystem->checkPriv($vUser,"mdm_listprof_uwallet")) { ?><input name="btWallet" type="button" class="btn btn-success btn-sm" id="btWallet" onclick="MM_goToURL('parent','../memstock/ewalletbal.php?&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Mutasi Saldo Reseller &raquo;" onMouseovers="showhint('Nex-Wallet '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>
        ...
        <!--  <? if ($oSystem->checkPriv($vUser,"mdm_listprof_walladj")) { ?><input name="btKoreksiRO" type="button" class="btn btn-danger btn-sm" id="bKoreksiRO" onclick="MM_goToURL('parent','../manager/koreksiro.php?&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="RO-Wallet Correction &raquo;" onMouseovers="showhint('RO-Wallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?> 
          ...
          <? if ($oSystem->checkPriv($vUser,"mdm_listprof_stockadj")) { ?><input name="btKoreksiSt" type="button" class="btn btn-success btn-sm" id="bKoreksiSt" onclick="MM_goToURL('parent','../manager/koreksistock.php?&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Stock Adjustment &raquo;" onMouseovers="showhint('UWallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>
...
<form name="memberForm">
    ...
    <table width="100%" border="0" align="center" cellpadding="1" cellspacing="0" class="table" style="background-color:white">
      ...
      <tr style="color:;font-weight:bold"> 
        ...
        <td width="363"><div align="center">Saldo</div></td>
	...
	/*			
      ...
      <tr  bgcolor="<?=$vActives?>" style="<?=$vStockistCSSs?>"  id="tr<?=$vIDSys?>"  > 
        ...
        <td  style="height: 39px" <? if($vFall==$db->f('fidmember')) echo "bgcolor=#0f0";?>><span >
          ...
          <input class="" id="rbSelected" style="width:20px;height:20px" name="rbSelected" type="radio" value="<?=$db->f('fidmember')?>" onClick="checkStatus('<?=$db->f('faktif')?>','<?=$db->f('fstockist')?>')" >
      ...
      <tr  > 
        ...
        Total Active Reseller: <?=$vRecordCount?>        , total Saldo (All Reseller) :</td>
      ...
      <div align="center">
			  ...
			  <input alt="Detail & Edit Member" name="btDetail2" type="button" class="btn btn-primary" id="btDetail2" onClick="MM_goToURL('parent','admin.php?menu=changeprofil&uMemberId='+getValue());return document.MM_returnValue" value="Detail" onMouseovers="showhint('Lihat detail /  Edit Member '+getValue(), this, event, '220px')" style="margin-top:5px">

			  <input name="btKomisi2" type="button" class="btn btn-default" id="btKomisi2" onClick="MM_goToURL('parent','admin.php?menu=stkomisi&uMemberId='+getValue());return document.MM_returnValue" value="Komisi" onMouseovers="showhint('Lihat Komisi Member '+getValue(), this, event, '190px')">

              <input name="btJar2" type="button" class="vsmallbutton" id="btJar2" onClick="MM_goToURL('parent','admin.php?menu=stjaringan&uMemberId='+getValue());return document.MM_returnValue" value="Net/Sponsor" onMouseovers="showhint('Lihat Status Network & Sponsor Member '+getValue(), this, event, '190px')">

              <input name="btGen2" type="button" class="vsmallbutton" id="btGen2" onClick="MM_goToURL('parent','admin.php?menu=genealogi&uMemberId='+getValue());return document.MM_returnValue" value="Geneologi" onMouseovers="showhint('Lihat Genealogi Member '+getValue(), this, event, '210px')" style="margin-top:5px">
          ...
          <? if ($oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="btGeneaS2" type="button" class="btn btn-success btn-sm" id="btGeneaS2" onclick="MM_goToURL('parent','../memstock/genealogispon.php?&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Genealogi Unilevel &raquo;" onMouseovers="showhint('Genealogi Unilevel '+getValue(), this, event, '210px')" style="margin-top:5px" />&nbsp;<? } ?>
					...
					<? if ($oSystem->checkPriv($vUser,"mdm_listprof_detail")) { ?> <input alt="Member Activation" name="btActiv2" type="button" class="btn btn-success btn-sm" id="btActiv2" onClick="MM_goToURL('parent','../memstock/activationadm.php?op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Activation&raquo;" onMouseovers="showhint('Aktiifasi Member '+getValue(), this, event, '220px')" style="margin-top:5px" >  <? } ?>        
					<? if ($oSystem->checkPriv($vUser,"mdm_listprof_repstock")) { ?><input name="btStock2" type="button" class="btn btn-success btn-sm" id="btBH" onclick="MM_goToURL('parent','../memstock/rptstock.php?&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="MS Stock &raquo;" onMouseovers="showhint('MS Stock '+getValue(), this, event, '210px')" style="margin-top:5px" /><? } ?>

                    <!-- <? if ($oSystem->checkPriv($vUser,"mdm_listprof_repkit")) { ?><input name="btKit2" type="button" class="btn btn-success btn-sm" id="bKit2" onclick="MM_goToURL('parent','../memstock/rptkit.php?&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Agent KIT Report &raquo;" onMouseovers="showhint('Stock Agent '+getValue(), this, event, '210px')" style="margin-top:5px" /><? } ?> -->

                    <? if ($oSystem->checkPriv($vUser,"mdm_listprof_uwallet")) { ?><input name="btWallet2" type="button" class="btn btn-success btn-sm" id="btWallet2" onclick="MM_goToURL('parent','../memstock/ewalletbal.php?&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Nex-Wallet &raquo;" onMouseovers="showhint('UWallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /><? } ?>
                    <? if ($oSystem->checkPriv($vUser,"mdm_listprof_uwallet")) { ?><input name="btWallet2" type="button" class="btn btn-success btn-sm" id="btWallet2" onclick="MM_goToURL('parent','../memstock/ewalletrobal.php?&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="RO-Wallet &raquo;" onMouseovers="showhint('UWallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /><? } ?>
         ...
         <? if ($oSystem->checkPriv($vUser,"mdm_listprof_repstinout")) { ?><input name="btStWallet5" type="button" class="btn btn-success btn-sm" id="btStWallet5" onclick="MM_goToURL('parent','../memstock/stockbalro.php?&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="St In/Out Rpt (RO Items) &raquo;" onMouseovers="showhint('UWallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>
          ...
          <? if ($oSystem->checkPriv($vUser,"mdm_listprof_repstinout")) { ?><input name="btStWallet7" type="button" class="btn btn-success btn-sm" id="btStWallet7" onclick="MM_goToURL('parent','../memstock/rptstockro.php?&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Stock Position (RO Items) &raquo;" onMouseovers="showhint('UWallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>
                    ...
                    <? if ($oSystem->checkPriv($vUser,"mdm_listprof_stockadj")) { ?><input name="btKoreksiSt2" type="button" class="btn btn-success btn-sm" id="bKoreksiSt2" onclick="MM_goToURL('parent','../manager/koreksistock.php?&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Stock Adjustment &raquo;" onMouseovers="showhint('UWallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /><? } ?>
                    ...
                    <? if ($oSystem->checkPriv($vUser,"mdm_listprof_repspon")) { ?><input name="btSpon2" type="button" class="btn btn-success btn-sm" id="btSpon2" onclick="MM_goToURL('parent','../memstock/stjaringan.php?&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Sponsorship &raquo;" onMouseovers="showhint('UWallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /><? } ?>
