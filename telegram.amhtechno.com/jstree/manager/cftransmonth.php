...
if ($vSort =='M')
   ...
   $vOrder.=" order by a.fdebit  ";
			 ...
			 $vsql="select a.*, b.*,c.fnamabank as cfnamabank,  date(a.ftanggal) as ftglcompile from tb_cftransmo a left join m_anggota b on a.fidmember=b.fidmember left join m_bank c on b.fnamabank=c.fkodebank where a.ftype='cfmonth' and ffeestatus='1' and fcftrans>0"; 
...
<div class="right_col" role="main">
		<div><label><h3>Monthly CF Trans</h3></label></div>
...
<button class="btn btn-info btn-sm" onClick="document.location.href='../manager/getexcel.php?arr=cftransmonth&file=dmonthly_cftrans_report_<?=$vUser?>'"><i class="fa fa-file-text-o"></i> Export Excel</button> 
