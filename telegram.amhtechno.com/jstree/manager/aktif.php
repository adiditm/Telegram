...
*/
	...
	<div class="right_col" role="main">
		<div><label><h3>Members Profile</h3></label></div>
...
<div class="row" style="text-align:left">
  <div class="col-lg-12">      
          ...
          <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?> <input alt="Detail & Edit Member" name="btDetail" type="button" class="btn btn-success btn-sm" id="btDetail2" onClick="return MM_goToURL('parent','../memstock/profile.php?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Detail/Edit&raquo;" onMouseovers="showhint('Lihat detail /  Edit Member '+getValue(), this, event, '220px')" style="margin-top:5px" >  <? } ?>        
         ...
         <!--  <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_repkit")) { ?><input name="btKit" type="button" class="btn btn-success btn-sm" id="bKit" onClick="return MM_goToURL('parent','../memstock/rptkitphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Agent KIT Report &raquo;" onMouseovers="showhint('KIT Agent '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?> -->
          ...
          <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_uwallet")) { ?><input name="btWallet" type="button" class="btn btn-success btn-sm" id="btWallet" onClick="return MM_goToURL('parent','../memstock/ewalletbalphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Mutasi Saldo Cash &raquo;" onMouseovers="showhint('Nex-Wallet '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>

          <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_uwallet")) { ?><input name="btWalletProd" type="button" class="btn btn-success btn-sm" id="btWalletProd" onClick="return MM_goToURL('parent','../memstock/ewalletprdphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Mutasi Saldo Prod. &raquo;" onMouseovers="showhint('Nex-Wallet '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>
          
          <? if (false) { ?><input name="btWalletKit" type="button" class="btn btn-success btn-sm" id="btWalletKit" onClick="return MM_goToURL('parent','../memstock/ewalletkitphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Mutasi Saldo KIT &raquo;" onMouseovers="showhint('Nex-Wallet '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>
          
                    <? if (false) { ?><input name="btWalletAcc" type="button" class="btn btn-success btn-sm" id="btWalletAcc" onClick="return MM_goToURL('parent','../memstock/ewalletaccphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Mutasi Saldo Support &raquo;" onMouseovers="showhint('Nex-Wallet '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>
          ...
          <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_walladj")) { ?><input name="btKoreksi" type="button" class="btn btn-success btn-sm" id="bKoreksi" onClick="return MM_goToURL('parent','../manager/koreksiphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Koreksi Saldo &raquo;" onMouseovers="showhint('Nex-Wallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>
          
<? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_walladj")) { ?><input name="btKoreksiAu" type="button" class="btn btn-success btn-sm" id="bKoreksiAu" onClick="return MM_goToURL('parent','../manager/koreksirophp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Koreksi Saldo Automain &raquo;" onMouseovers="showhint('Nex-Wallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>          
          
 <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="btEfund" type="button" class="btn btn-success btn-sm" id="btEfund" onClick="return MM_goToURL('parent','../manager/efundmemphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Entri Automain eFund &raquo;" onMouseovers="showhint('Nex-Wallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>          
          
 <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_walladj")) { ?><input name="btSet" type="button" class="btn btn-success btn-sm" id="btSet" onClick="return MM_goToURL('parent','../manager/koreksistockistphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Set Saldo Jaminan Stockist &raquo;" onMouseovers="showhint('Nex-Wallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>
        ...
        <!--  <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_walladj")) { ?><input name="btKoreksiRO" type="button" class="btn btn-danger btn-sm" id="bKoreksiRO" onClick="return MM_goToURL('parent','../manager/koreksirophp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="RO-Wallet Correction &raquo;" onMouseovers="showhint('RO-Wallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?> 
          ...
          <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_reporderhist")) { ?><input name="btHist" type="button" class="btn btn-success btn-sm" id="btHist" onClick="return MM_goToURL('parent','../memstock/historyrophp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="History Penjualan &raquo;" onMouseovers="showhint('UWallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>
         ...
         <!--  <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_repspon")) { ?><input name="btSpon" type="button" class="btn btn-success btn-sm" id="btSpon" onClick="return MM_goToURL('parent','../memstock/stjaringanphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Sponsorship Report &raquo;" onMouseovers="showhint('UWallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?> -->
          ...
          <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="btGenea" type="button" class="btn btn-success btn-sm" id="btGenea" onClick="return MM_goToURL('parent','../memstock/genealogi2php?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Genealogi &raquo;" onMouseovers="showhint('UWallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" />&nbsp;<? } ?>

         <? if (false) { ?><input name="btGeneaS" type="button" class="btn btn-success btn-sm" id="btGeneaS" onClick="return MM_goToURL('parent','../memstock/genealogisponphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Genealogi Unilevel &raquo;" onMouseovers="showhint('Genealogi Unilevel '+getValue(), this, event, '210px')" style="margin-top:5px" />&nbsp;<? } ?>
         
         
		<? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="btBBP" type="button" class="btn btn-success btn-sm" id="btBBP" onClick="return MM_goToURL('parent','../memstock/rptbnssponrealphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Bns Pengembangan Tim &raquo;" onMouseovers="showhint('Genealogi Unilevel '+getValue(), this, event, '210px')" style="margin-top:5px" />&nbsp;<? } ?>

		<? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="btBBP" type="button" class="btn btn-success btn-sm" id="btBBP" onClick="return MM_goToURL('parent','../memstock/pairingphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Bns Pengembangan Harian &raquo;" onMouseovers="showhint('Genealogi Unilevel '+getValue(), this, event, '210px')" style="margin-top:5px" />&nbsp;<? } ?>
        
<? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="btBBPcf" type="button" class="btn btn-success btn-sm" id="btBBPcf" onClick="return MM_goToURL('parent','../memstock/pairingcfphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Carry Forward Bonus &raquo;" onMouseovers="showhint('Genealogi Unilevel '+getValue(), this, event, '210px')" style="margin-top:5px" />&nbsp;<? } ?>        

		<? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="btBBP" type="button" class="btn btn-success btn-sm" id="btBBP" onClick="return MM_goToURL('parent','../memstock/rptbnsmatchphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Bns Royalti &raquo;" onMouseovers="showhint('Genealogi Unilevel '+getValue(), this, event, '210px')" style="margin-top:5px" />&nbsp;<? } ?>

        
		<? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="btBBP" type="button" class="btn btn-success btn-sm" id="btBBP" onClick="return MM_goToURL('parent','../memstock/rptprivrophp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Bns Belanja Pribadi &raquo;" onMouseovers="showhint('Genealogi Unilevel '+getValue(), this, event, '210px')" style="margin-top:5px" />&nbsp;<? } ?>
        <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="btBBG" type="button" class="btn btn-success btn-sm" id="btBBG" onClick="return MM_goToURL('parent','../memstock/rptgrouprophp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Bns Pengembangan Bulanan &raquo;" onMouseovers="showhint('Genealogi Unilevel '+getValue(), this, event, '210px')" style="margin-top:5px" />&nbsp;<? } ?>
        <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="BtBMM" type="button" class="btn btn-success btn-sm" id="BtBMM" onClick="return MM_goToURL('parent','../memstock/rptmegamatchphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Bns Penghargaan Kepemimpinan &raquo;" onMouseovers="showhint('Genealogi Unilevel '+getValue(), this, event, '210px')" style="margin-top:5px" />&nbsp;<? } ?>
        
        <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="BtBMM3" type="button" class="btn btn-success btn-sm" id="BtBMM3" onClick="return MM_goToURL('parent','../memstock/rptmegamatchphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Bns Klub Presiden &raquo;" onMouseovers="showhint('Genealogi Unilevel '+getValue(), this, event, '210px')" style="margin-top:5px" />&nbsp;<? } ?>
        
        <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="btRoHist" type="button" class="btn btn-success btn-sm" id="btRoHist" onClick="return MM_goToURL('parent','../memstock/historyrophp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="RO History &raquo;" onMouseovers="showhint('Genealogi Unilevel '+getValue(), this, event, '210px')" style="margin-top:5px" />&nbsp;<? } ?>


 <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="btOneRoHist" type="button" class="btn btn-success btn-sm" id="btOneRoHist" onClick="return MM_goToURL('parent','../memstock/rptrostockistphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Bns Onetime + RO Stockist &raquo;" onMouseovers="showhint('Genealogi Unilevel '+getValue(), this, event, '210px')" style="margin-top:5px" />&nbsp;<? } ?>
 
 
 <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="btPoinStock" type="button" class="btn btn-success btn-sm" id="btPoinStock" onClick="return MM_goToURL('parent','../memstock/rptpoinstockistphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Bns Poin Stockist &raquo;" onMouseovers="showhint('Genealogi Unilevel '+getValue(), this, event, '210px')" style="margin-top:5px" />&nbsp;<? } ?>
...
<form name="memberForm">
	...
	/*			
      ...
      <tr  bgcolor="<?=$vActives?>" style="<?=$vStockistCSSs?>"  id="tr<?=$vIDSys?>"  > 
		 ...
		 */ 
          ...
          <?
			  ...
			  else if ($vStockKind == '3')	 
			     $vSKindText = '<b>Master Stockist</b>'; 	 
      ...
      <tr  > 
       ...
       <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_detail")) { ?> <input alt="Detail & Edit Member" name="btDetail" type="button" class="btn btn-success btn-sm" id="btDetail2" onClick="return MM_goToURL('parent','../memstock/profile.php?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Detail/Edit&raquo;" onMouseovers="showhint('Lihat detail /  Edit Member '+getValue(), this, event, '220px')" style="margin-top:5px" >  <? } ?>        
         <!-- <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_detail")) { ?> <input alt="Member Activation" name="btActiv" type="button" class="btn btn-success btn-sm" id="btActiv" onClick="return MM_goToURL('parent','../memstock/activationadm.php?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Actvation&raquo;" onMouseovers="showhint('Aktiifasi Member '+getValue(), this, event, '220px')" style="margin-top:5px" >  <? } ?>       
...
<? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_walladj")) { ?><input name="btKoreksiAu1" type="button" class="btn btn-success btn-sm" id="bKoreksiAu1" onClick="return MM_goToURL('parent','../manager/koreksirophp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Koreksi Saldo Automain &raquo;" onMouseovers="showhint('Nex-Wallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?> 
          
 <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_genealogi")) { ?><input name="btEfund1" type="button" class="btn btn-success btn-sm" id="btEfund1" onClick="return MM_goToURL('parent','../manager/efundmemphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Entri Automain eFund &raquo;" onMouseovers="showhint('Nex-Wallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>          
          
           <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_walladj")) { ?><input name="btSet1" type="button" class="btn btn-success btn-sm" id="btSet1" onClick="return MM_goToURL('parent','../manager/koreksistockistphp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Set Saldo Jaminan Stockist &raquo;" onMouseovers="showhint('Nex-Wallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?>
        <!--  <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_walladj")) { ?><input name="btKoreksiRO" type="button" class="btn btn-danger btn-sm" id="bKoreksiRO" onClick="return MM_goToURL('parent','../manager/koreksirophp?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="RO-Wallet Correction &raquo;" onMouseovers="showhint('RO-Wallet Correction '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?> 
