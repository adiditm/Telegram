...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <?
                    $vSQL="select * from m_menu where is_active='1' and fismenu='1' and flevel='1' order by menu_order ";
                    $dbmenu->query($vSQL);
                ...
                <? } ?>  
                    <ul class="nav child_menu " <? if ($vCurrent==$vMenuID) echo 'style="display: block;"';?> >
                      <?
                         $vSQL="select * from m_menu where is_active='1' and fismenu='1' and flevel='2' and fparent='$vMenuID' order by menu_order  ";
                       $dbmenuin->query($vSQL);
