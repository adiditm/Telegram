...
$opts['fdd']['fnamabank']['values']['table']       = 'm_bank'; 
$opts['fdd']['fnamabank']['values']['column']      = 'fkodebank'; 
$opts['fdd']['fnamabank']['values']['description'] = 'fnamabank'; // optional
