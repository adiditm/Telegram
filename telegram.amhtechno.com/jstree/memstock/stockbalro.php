...
$(document).ready(function(){
      $('#caption').html('Stock In/Out RO Items <?=$vUserChoosed?> (<?=$oMember->getMemberName($vUserChoosed);?>)');
...
<div class="row hide">
            ...
            <div align="left" class="col-sm-6 col-md-6 col-xs-6">
              ...
              <select name="lmColor" id="lmColor" class="form-control">
                <option selected="selected" value="">--All--</option>
                <? 
                   $vSQL="select distinct fcolor from tb_stok_positionro where fidmember='$vUserChoosed'  order by fcolor";
                   $dbin->query($vSQL);
                   while ($dbin->next_record()) {
...
<br>
        ...
        <?
			    ...
			    $vSQL="select * from tb_mutasi_stokro where  1 and fidproduk='$vProd'  and fidmember='$vUserChoosed' ";
				$vSQL.=$vCrit;
