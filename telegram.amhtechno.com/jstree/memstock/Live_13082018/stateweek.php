...
date_default_timezone_set('Asia/Jakarta');
 ...
 $vSQL="select count(*) as fjumrec from tb_mutasi where fidmember='$vUserChoosed' and fkind in('resetweek','bonusro','bonusrogroup','bonusmega') $vCrit";
...
$(document).ready(function(){
      ...
      $('#caption').html('Weekly Bonus Statement');
  ...
  <link rel="stylesheet" type="text/css" href="../js/bootstrap-datetimepicker/css/datetimepicker-custom.css" />
	...
	<div id="content" class="content">
			<ol class="breadcrumb pull-right">
				<h4>
				  <li><a href="javascript:;">Weekly Bonus Statement </a></li></h4>
...
<br>
        ...
        <?
			  ...
			  //  $vSQL="select * from tb_mutasi where  1 and fidmember='$vUserChoosed' and fkind in('resetweek','spon','pairing') ";
				 $vSQL="select * from tb_mutasi where  1 and fidmember='$vUserChoosed' and fkind in('resetweek','bonusro','bonusrogroup','bonusmega') ";
				$vSQL.=$vCrit;
