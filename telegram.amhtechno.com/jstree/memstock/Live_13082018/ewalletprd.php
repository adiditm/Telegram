<? 
 ...
 if ($vSearch!="")	{	
  ...
  $vSQL="select count(*) as fjumrec from tb_mutasi_wprod where fidmember='$vUserChoosed' $vCrit";
...
<div id="content" class="content">
			<ol class="breadcrumb pull-right">
				<h4><li><a href="javascript:;">Ewallet Automaintenance </a></li></h4>
...
<br>
        ...
        <?
			    ...
			    $vSQL="select * from tb_mutasi_wprod where  1 and fidmember='$vUserChoosed' ";
