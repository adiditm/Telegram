...
<div id="content" class="content">
			<ol class="breadcrumb pull-right">
				<h4>
				  <li><a href="javascript:;">History PO</a></li></h4>
...
<br />
    ...
    <div class="table-responsive">
        <table width="90%" border="0" class="table table-striped">
          ...
          <? 
             $vNo=0;
			 $vsql="select distinct ftanggal, fidpenjualan,fidseller,fidmember, fketerangan, '1' as fstatus  from tb_trxstok where  fidmember='$vUserActive' and fjenis='PS'"; 
			 $vsql.=$vCrit;

			 
			 $vsql.=" union all select distinct ftanggal, fidpenjualan,fidseller,fidmember, fketerangan, '0' as fstatus  from tb_trxstok_temp where  fidmember='$vUserActive' and fjenis='PS'"; 
			 $vsql.=$vCrit;
