<? 
 ...
 if ($vSearch!="")	{	
  ...
  $vSQL="select count(*) as fjumrec from tb_mutasi where fkind='unile' and fidmember='$vUserChoosed' $vCrit";
...
<div class="right_col" role="main">
		<div><label>
		<h3>Report Bonus  Unilevel RO<? if ($vRefUser !='') echo " ($vRefUser)";?></h3></label></div> 
...
<br>
        ...
        <tr style="font-weight:bold">
          ...
          <td width="22%" align="center" class="auto-style1">Date</td>

          <td width="52%" align="center" class="auto-style1">Description</td>

          <td width="19%" align="center">Amount (Nett)</td>
          <td width="19%" align="center" nowrap>Bonus Funder</td>
          <td width="19%" align="center">Reference</td>
        ...
        <?
			    ...
			    $vSQL="select * from tb_mutasi where  fkind='unile' and fidmember='$vUserChoosed' ";
				...
				$db->query($vSQL);
				$vArrData="";
				$vArrHead=array('No.','Date','Description','Amount');
				$vArrBlank=array('','','','','','');
        ...
        <tr class="tbrekapfont">
                ...
                <?
				 ...
				 $vDesc = str_replace("nett  nett  nett  nett","nett",$vDesc);
					 $vDesc = str_replace("nett  nett  nett","nett",$vDesc);
					  ...
					  $vDesc = str_replace("with PPH 20 + 50%","",$vDesc);
          ...
          <td align="center"><?=$db->f('fidfunder');?></td>
          <td align="center"><?=$db->f('fref');?></td>
