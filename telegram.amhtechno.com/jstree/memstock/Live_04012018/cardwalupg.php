...
$(document).ready(function(){
    ...
    $('#caption').html('Card Upgrade Wallet ');
  ...
  <div class="content-wrapper">
      ...
      <table  border="0" align="left" cellpadding="1" cellspacing="0" class="table table-striped table-bordered">
        ...
        <tr >
          <td align="center"><div align="right"><font color="#000000">
            <?
			 $vAllCard=$oJual->getAllCardUpg($vUser);
			 echo number_format($vAllCard,0,',','.');
		  ?>
            </font></div></td> 
          <td align="center"> <div align="right"><font color="#000000">
            <?
			 $vSold=$oJual->getSoldCardUpg($vUser);
			 echo number_format($vSold,0,',','.');
		  ?>
            </font></div></td>
          <td align="center"> <div align="right"><font color="#000000">
            <?
			 $vSaldo=$oJual->getSaldoCardUpg($vUser);
    ...
    <p align="left" class="style2"><font face="Verdana, Arial, Helvetica, sans-serif"><strong>History Pembelian Kartu </strong></font></p>
      ...
      <table  border="0" align="left" cellpadding="1" cellspacing="0" class="table table-striped table-bordered">
        ...
        <?php
		$vsql="select * from tb_skit_upg where fpendistribusi='$vUser' order by ftgldist";
		$db->query($vsql);
      ...
      <div class="col-lg-10">   
        ...
        <?php
		$vsql="select * from m_anggota where fidmember in (select fserno from tb_skit_upg where fpendistribusi='$vUser') and faktif=1";
		$db->query($vsql);
		while ($db->next_record())
		{
