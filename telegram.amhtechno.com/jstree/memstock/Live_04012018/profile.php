  	 ...
  	 if ($oMember->updateMember($tfSerno,$tfIdent,$tfNama,$tfTempat,$tfTglLahir,$lmNation,$tfSex,$taAlamat,$lmCountry,$lmProp,$lmKota,$tfPhone,$tfHP,$tfEmail,$tfBank,$tfRek,$tfAtasNama,$tfKotaBank,$tfBranchBank,$lmCountryBank,$tfSwift,$tfNPWP,$tfSernoSpon,$hStock,$tfAutoShip,$hPict)==1) {  
				...
				if ($vOldStockStat != $vNewStockStat ) { //logging
				    if (($vOldStockStat =='0' && $vNewStockStat =='2') || ($vOldStockStat =='1' && $vNewStockStat =='2')) {
						...
						$vKet="Demote stockist $tfSerno to mobile stockist";
  ...
  <link rel="stylesheet" type="text/css" href="../js/bootstrap-datetimepicker/css/datetimepicker-custom.css" />
		...
		<div id="content" class="content">
			<ol class="breadcrumb pull-right">
				<h4><li><a href="javascript:;">Member Profile</a></li></h4>
                                    ...
                                    <label for="exampleInputEmail1">ID Card*</label>
                                     <div class="input-group">
                                       <span class="input-group-addon"> <i class="fa fa-user"></i></span>
                                    	<input  type="text" class="form-control" id="tfIdent" name="tfIdent" placeholder="ID Card/Driving License/Passport No.*" value="<?=$db->f('fnoktp')?>">
                                      </div>
                             </div>                             
</div>    
 ...
 <div class="row">                         
                            ...
                            <div class=" col-lg-12 divtr">
                                <label for="exampleInputEmail1">Full Name*</label>
                                 <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                <input <? if (!$oSystem->checkPriv($_SESSION['LoginUser'],"mdm_setting_ident")) echo 'readonly';?> onBlur="" onKeyUp="" type="text" class="form-control" id="tfNama" name="tfNama" placeholder="Full Name*" value="<?=$db->f('fnama')?>" >
                                </div>
                            </div>
</div>                            
...
<? if (false) if ($db->f('ftglupgrade') != '0000-00-00 00:00:00') { ?>
 ...
 <div class="row">                           
          				<div class="col-lg-6 divtr">
                                    <label for="exampleInputEmail1">Name in Account*</label>
                                     <div class="input-group">
                                       <span class="input-group-addon"> <i class="fa fa-user"></i></span>
                                    	<input  value="<?=$db->f('fatasnama')?>" type="text" class="form-control" id="tfAtasNama" name="tfAtasNama" placeholder="Bank Account Name (Same With The Distributor's Name)*">
                                      </div>
                             </div>  
                             ...
                             <div class="col-lg-6 " style="margin-left:1.3em">
								...
								<? if ($oMember->isStockist($vUserActive)==0 ) { ?>
								 ...
								 <div class="input-group" style="display:inline">
                                        ...
                                        <button  id="btnSubmit" type="button" class="btn btn-success"  onclick="setStock();" ><i class="fa fa-car" style="display:inline"></i> Promote Mobile Stockist</button>
                                </div>        
                                <? } ?>
                                
								<? if ($oMember->isStockist($vUserActive)==0 || $oMember->isStockist($vUserActive)==1) { ?>
