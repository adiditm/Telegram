...
$vCrit.=" and date(ftanggal) >= '$vAwal' and date(ftanggal) <= '$vAkhir'" ;
 ...
 $vsql="select * from tb_kom_pr where fidreceiver='$vUserActive' and ffeestatus='2' ";
 $vsql.=$vCrit;
...
<div class="right_col" role="main">
		<div><label>
		<h3>Poin   Reward RO<? if ($vRefUser !='') echo " ($vRefUser)";?></h3></label></div> 
...
<br />
    ...
    <div class="table-responsive">
        <table width="90%" border="0" class="table table-striped">
          ...
          <? 
             $vNo=0;
			 $vsql="select fidreceiver, fidregistrar,ffee,ffeenom,ftanggal,fcf,flr,fidfee from tb_kom_pr where fidreceiver='$vUserActive' and ffeestatus='2' "; 
			 $vsql.=$vCrit;
			 $vsql.=" order by ftanggal ";
