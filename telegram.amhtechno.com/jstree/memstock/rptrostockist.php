<? 
 ...
 if ($vSearch!="")	{	
  ...
  $vSQL="select count(*) as fjumrec from tb_kom_stockist where fkind in('bnstrxkitst','bnstrxst','bnsone')  and fidmember='$vUserChoosed' $vCrit";
...
<div class="right_col" role="main">
		<div><label><h3>Bonus RO dari Stockist yang disponsori</h3></label></div> 
...
<br>
        ...
        <?
			    ...
			    $vSQL="select * from tb_kom_stockist where  fkind in('bnstrxkitst','bnstrxst','bnsone') and fidmember='$vUserChoosed' ";
