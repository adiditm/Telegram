<? 
 ...
 if ($vSearch!="")	{	
  ...
  $vSQL="select count(*) as fjumrec from tb_mutasi where fkind='pres' and fidmember='$vUserChoosed' $vCrit";
...
<div class="right_col" role="main">
		<div><label>
		<h3>Report Bonus  Presenter <? if ($vRefUser !='') echo " ($vRefUser)";?></h3></label></div> 
...
<br>
        ...
        <?
			    ...
			    $vSQL="select * from tb_mutasi where  fkind='pres' and fidmember='$vUserChoosed' ";
