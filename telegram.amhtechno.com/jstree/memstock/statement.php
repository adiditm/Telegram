...
<?
 ...
 if ($vSearch!="")	{	
  ...
  $vSQL="select count(*) as fjumrec from tb_mutasi where fidmember='$vUserChoosed' and fkind in('resetweek','spon','pairing') $vCrit";
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="modalhead">Weekly Bonus Statement</h4> <?=$vFilterText?>
        </div>
        <div class="modal-body" style="padding: 2em 4em 3em 4em">
          <div class="row">
             <div class="col-lg-6" style="white-space: nowrap;">
             <label id="lblDesc">Weekly Bonus&nbsp;  </label>
             </div>
...
<div style="float:left;margin-top:1em;width:100%">
        <p>
			  ...
			  Weekly Bonus Statement [<?=$oMember->getMemberName($vUserChoosed)?>]
        ...
        <?
			  ...
			  //  $vSQL="select * from tb_mutasi where  1 and fidmember='$vUserChoosed' and fkind in('resetweek','spon','pairing') ";
				 $vSQL="select * from tb_mutasi where  1 and fidmember='$vUserChoosed' and fkind in('resetweek') ";
				$vSQL.=$vCrit;
