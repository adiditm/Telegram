...
<div class="right_col" role="main">
				 ...
				 <div><label><h3>System Setting</h3></label></div>
...
$opts['filters'] = 'fket <> \'\'  and factive=\'1\' ' ;
$opts['multiple'] = '4';
...
$opts['buttons']['L']['up'] = array('<<','<','view','copy','change',
                                    '>','>>','goto','goto_combo');
$opts['buttons']['L']['down'] = $opts['buttons']['L']['up'];

$opts['buttons']['F']['up'] = array('<<','<','view','copy','change',
                                    '>','>>','goto','goto_combo');
